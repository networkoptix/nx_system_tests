...
from arm_tests.machines_market import MediaserverPrerequisitesSnapshot


def _lock_mediaserver_prerequisites_machine(machine_description: MachineDescription):
    market = HighPriorityMarket()
    with MediaserverPrerequisitesSnapshot(machine_description).lease(market) as running_machine:
...
if __name__ == '__main__':
    ...
    _lock_mediaserver_prerequisites_machine(get_machine_description(parser.parse_args()))
