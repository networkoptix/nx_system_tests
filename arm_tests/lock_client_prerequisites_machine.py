...
def _lock_client_prerequisites_machine(machine_description: MachineDescription):
    market = HighPriorityMarket()
    with ClientPrerequisitesSnapshot(machine_description).lease(market) as running_machine:
...
if __name__ == '__main__':
    ...
    _lock_client_prerequisites_machine(get_machine_description(parser.parse_args()))
