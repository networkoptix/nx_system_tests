...
class test_ubuntu18_smb_win11_mediaserver_v0(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_10x_space_difference(args.distrib_url, ('ubuntu18', 'win11'), 'v0', exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu18_smb_win11_mediaserver_v0().main())
