...
class test_ubuntu22_v4plus_mirrored(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_archive_reindex(args.distrib_url, 'ubuntu22', True, 'v4plus', exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu22_v4plus_mirrored().main())
