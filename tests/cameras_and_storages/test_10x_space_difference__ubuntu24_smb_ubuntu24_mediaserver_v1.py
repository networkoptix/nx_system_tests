...
class test_ubuntu24_smb_ubuntu24_mediaserver_v1(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_10x_space_difference(args.distrib_url, ('ubuntu24', 'ubuntu24'), 'v1', exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu24_smb_ubuntu24_mediaserver_v1().main())
