...
class test_ubuntu22_win11_v1_licenses_for_all(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_disable_cameras_recording_on_license_problems(args.distrib_url, ('ubuntu22', 'win11', 'win11'), 'v1', 1, 3, 2, exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu22_win11_v1_licenses_for_all().main())
