...
class test_ubuntu22_v0_before_start(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_removable_storage(args.distrib_url, 'ubuntu22', True, 'v0', exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu22_v0_before_start().main())
