...
class test_ubuntu22_v0_webm(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_media_stream_should_be_loaded_correctly(args.distrib_url, 'ubuntu22', 'webm', 'v0', exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu22_v0_webm().main())
