...
def _test_on_off_switch_mechanics(distrib_url, two_vm_types, api_version, exit_stack):
    ...
    first.api.set_backup_quality_for_newly_added_cameras(low=True, high=True)
    ...
    assert backup_quality_for_new_added_cameras.high
    ...
    assert camera_backup_quality.high
