...
class test_ubuntu22_v2_live_viewer(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_cannot_watch_an_archive(args.distrib_url, 'ubuntu22', 'v2', 'live_viewer', exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu22_v2_live_viewer().main())
