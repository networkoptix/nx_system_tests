...
def _test_can_watch_an_archive(distrib_url, one_vm_type, api_version, actor, exit_stack):
    ...
    assert mediaserver_api_for_actor.list_recorded_periods([dummy_camera.id])[0]
