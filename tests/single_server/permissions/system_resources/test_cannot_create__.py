...
def _test_cannot_create(distrib_url, one_vm_type, api_version, actor, exit_stack):
    ...
    with assert_raises(Forbidden):
        mediaserver_api_for_actor.http_post(
            f'rest/{api_version}/system/settings', {
                'name': f'resource_created_by_user_{actor}',
                'value': '',
                },
            )
