...
class test_ubuntu22_v1_admin(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_can_see_cameras_created_by_admin(args.distrib_url, 'ubuntu22', 'v1', 'admin', exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu22_v1_admin().main())
