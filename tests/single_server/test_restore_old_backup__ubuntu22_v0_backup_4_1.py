...
class test_ubuntu22_v0_backup_4_1(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_restore_from_old_version(args.distrib_url, 'ubuntu22', 'backup', '4.1', 'v0', exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu22_v0_backup_4_1().main())
