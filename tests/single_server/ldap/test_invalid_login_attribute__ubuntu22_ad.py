...
class test_ubuntu22_ad(VMSTest):
    ...
    TestRail: https://networkoptix.testrail.net/index.php?/cases/view/122145
    """

    def _run(self, args, exit_stack):
        _test_invalid_login_attribute(args.distrib_url, 'ubuntu22', 'active_directory', exit_stack)
