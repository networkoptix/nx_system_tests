...
class test_win11_correct_source_correct_event_id_v0(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_storage_event_notification(args.distrib_url, 'win11', CORRECT_SOURCE, CORRECT_EVENT_IDS, True, 'v0', exit_stack)


if __name__ == '__main__':
    exit(test_win11_correct_source_correct_event_id_v0().main())
