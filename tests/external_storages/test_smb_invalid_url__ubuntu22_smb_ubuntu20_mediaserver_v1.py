...
class test_ubuntu22_smb_ubuntu20_mediaserver_v1(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_smb_invalid_url(args.distrib_url, ('ubuntu22', 'ubuntu20'), 'v1', exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu22_smb_ubuntu20_mediaserver_v1().main())
