...
class test_win11_smb_ubuntu22_mediaserver_v0(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_nas_reserved_space_with_quota_enabled(args.distrib_url, ('win11', 'ubuntu22'), 'v0', exit_stack)


if __name__ == '__main__':
    exit(test_win11_smb_ubuntu22_mediaserver_v0().main())
