...
class test_ubuntu22_smb_ubuntu22_mediaserver_v1_no_recording_enabled_before_restart(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_dismount_nas_after_server_stopped(args.distrib_url, ('ubuntu22', 'ubuntu22'), 'v1', False, exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu22_smb_ubuntu22_mediaserver_v1_no_recording_enabled_before_restart().main())
