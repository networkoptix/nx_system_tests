...
class test_bookmark_remove_using_timeline_tooltip(VMSTest):
    """Remove bookmark using tooltip.

    Create bookmark, verify existence, remove.

    TestRail: https://networkoptix.testrail.net/index.php?/cases/view/60
