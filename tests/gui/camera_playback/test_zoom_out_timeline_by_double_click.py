...
class test_zoom_out_timeline_by_double_click(VMSTest):
    """Zoom out timeline by double click.

    Open camera with recorded data, zoom in timeline and zoom it out by double click on scrollbar

    TestRail: https://networkoptix.testrail.net/index.php?/cases/view/1569
    ...
    def _run(self, args, exit_stack):
        ...
        timeline.zoom_out_by_double_click()
...
if __name__ == '__main__':
    exit(test_zoom_out_timeline_by_double_click().main())
