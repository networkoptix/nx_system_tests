...
class test_deactivations_not_displayed_for_saas_license(VMSTest):
    """Deactivations Remaining not displayed for SaaS License.

    Open license details for SaaS license, check 'Deactivations Remaining' is not present there.
    TestRail: https://networkoptix.testrail.net/index.php?/cases/view/99746
    ...
    def _run(self, args, exit_stack):
        ...
        server_vm.api.activate_license(license_server.generate({
            ...
            'ORDERTYPE': 'saas',
            'FIXED_EXPIRATION_TS': (date.today() + timedelta(days=30)).strftime('%m/%d/%Y'),
            }))
...
if __name__ == '__main__':
    exit(test_deactivations_not_displayed_for_saas_license().main())
