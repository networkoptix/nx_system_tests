...
class test_remove_offline_system_using_context_menu(VMSTest):
    """Welcome screen remove offline system using dropdown menu.

    TestRail: https://networkoptix.testrail.net/index.php?/cases/view/79189
    ...
    def _run(self, args, exit_stack):
        ...
        assert not online_tile.has_dropdown_menu_option('Delete')
        assert not offline_tile.is_online()
        assert offline_tile.has_dropdown_menu_option('Delete')
        offline_tile.remove_using_dropdown_menu()
...
if __name__ == '__main__':
    exit(test_remove_offline_system_using_context_menu().main())
