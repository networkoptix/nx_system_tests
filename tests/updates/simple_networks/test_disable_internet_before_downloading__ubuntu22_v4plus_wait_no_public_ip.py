...
class test_ubuntu22_v4plus_wait_no_public_ip(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_disable_internet_before_downloading(args.distrib_url, ('ubuntu22', 'ubuntu22'), 'v4plus', False, exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu22_v4plus_wait_no_public_ip().main())
