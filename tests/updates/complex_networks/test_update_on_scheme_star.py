...
class test_v4plus(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_update_on_scheme_star(args.distrib_url, 'v4plus', exit_stack)


def _test_update_on_scheme_star(distrib_url, api_version, exit_stack):
