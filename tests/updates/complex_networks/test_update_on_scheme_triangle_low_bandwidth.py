...
class test_v4plus(VMSTest):
    """Test update on scheme triangle low bandwidth.

    Selection-Tag: no_testrail
    """

    def _run(self, args, exit_stack):
        _test_update_on_scheme_triangle_low_bandwidth(args.distrib_url, 'v4plus', exit_stack)


def _test_update_on_scheme_triangle_low_bandwidth(distrib_url, api_version, exit_stack):
    ...
    machines['first'].vm_control.limit_bandwidth(5000)
    machines['second'].vm_control.limit_bandwidth(500)
