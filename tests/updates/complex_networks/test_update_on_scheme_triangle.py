...
class test_v4plus(VMSTest):
    """Test update on scheme triangle.
    ...
    def _run(self, args, exit_stack):
        _test_update_on_scheme_triangle(args.distrib_url, 'v4plus', exit_stack)


def _test_update_on_scheme_triangle(distrib_url, api_version, exit_stack):
