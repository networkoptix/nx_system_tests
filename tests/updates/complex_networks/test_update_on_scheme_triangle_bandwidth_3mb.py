...
class test_v4plus(VMSTest):
    """Test update on scheme triangle bandwidth 3mb.
    ...
    def _run(self, args, exit_stack):
        _test_update_on_scheme_triangle_bandwidth_3mb(args.distrib_url, 'v4plus', exit_stack)


def _test_update_on_scheme_triangle_bandwidth_3mb(distrib_url, api_version, exit_stack):
    ...
    machines['first'].vm_control.limit_bandwidth(3000)
    machines['second'].vm_control.limit_bandwidth(42000)
    machines['proxy-1'].vm_control.limit_bandwidth(90000)
    setup_system(system, [
