...
class test_migration_from_release_5_1_4(VMSTest):
    """Test migration from release 5 1 4.
    ...
    def _run(self, args, exit_stack):
        release_distrib_url = 'https://artifactory.us.nxteam.dev/artifactory/release-vms/default/5.1.4.38659/linux/'
        _test_check_db_integrity_after_update(release_distrib_url, args.distrib_url, exit_stack)


if __name__ == '__main__':
    exit(test_migration_from_release_5_1_4().main())
