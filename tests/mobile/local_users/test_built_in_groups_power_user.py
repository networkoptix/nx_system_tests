...
class test_built_in_groups_power_user(VMSTest):
    """Local User. Live Viewer.

    Selection-Tag: 6820
    Selection-Tag: mobile-gitlab
    TestRail: https://networkoptix.testrail.net/index.php?/cases/view/6820
    """
    ...
    def _run(self, args, exit_stack):
        ...
        power_user = server_vm.api.add_local_admin('power_user', 'WellKnownPassword2')
...
if __name__ == '__main__':
    exit(test_built_in_groups_power_user().main())
