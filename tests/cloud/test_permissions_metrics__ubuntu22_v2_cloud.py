...
class test_ubuntu22_v2_cloud(VMSTest, CloudTest):
    ...
    def _run(self, args, exit_stack):
        _test_owner_can_get_metrics(args.cloud_host, args.distrib_url, 'win11', 'cloud', 'v2', exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu22_v2_cloud().main())
