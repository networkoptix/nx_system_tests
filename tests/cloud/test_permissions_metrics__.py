...
def _test_owner_can_get_metrics(cloud_host, distrib_url, one_vm_type, system_type, api_version, exit_stack):
    ...
    mediaserver.api.get_metrics('system_info')
    mediaserver.api.list_metrics_alarms()
