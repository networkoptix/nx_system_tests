...
class test_win11_win11_v1_settings_from_local(VMSTest, CloudTest):
    ...
    def _run(self, args, exit_stack):
        _test_merge_cloud_systems_with_different_owners(args.cloud_host, args.distrib_url, ('win11', 'win11'), 'v1', False, exit_stack)


if __name__ == '__main__':
    exit(test_win11_win11_v1_settings_from_local().main())
