...
class test_win11_win11_v1(VMSTest, CloudTest):
    ...
    def _run(self, args, exit_stack):
        _test_merge_cloud_with_local(args.cloud_host, args.distrib_url, ('win11', 'win11'), 'v1', exit_stack)


if __name__ == '__main__':
    exit(test_win11_win11_v1().main())
