...
class test_win11_v1_all_users(VMSTest, CloudTest):
    ...
    def _run(self, args, exit_stack):
        _test_reconnect_to_another_cloud_account(args.cloud_host, args.distrib_url, 'win11', 'v1', False, exit_stack)


if __name__ == '__main__':
    exit(test_win11_v1_all_users().main())
