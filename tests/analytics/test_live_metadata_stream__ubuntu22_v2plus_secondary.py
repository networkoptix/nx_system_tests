...
class test_ubuntu22_v2plus_secondary(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_live_metadata_stream(args.distrib_url, 'ubuntu22', 'v2plus', 'secondary', exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu22_v2plus_secondary().main())
