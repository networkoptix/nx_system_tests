...
class test_ubuntu22_v0_error_triggered(VMSTest):
    """Test log level.
    ...
    def _run(self, args, exit_stack):
        _test_log_level(args.distrib_url, 'ubuntu22', 'Error', True, 'v0', exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu22_v0_error_triggered().main())
