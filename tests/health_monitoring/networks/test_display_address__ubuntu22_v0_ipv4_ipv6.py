...
class test_ubuntu22_v0_ipv4_ipv6(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_display_address(args.distrib_url, 'ubuntu22', 'v0', ['10.10.10.10/24', 'fd00::1/8'], exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu22_v0_ipv4_ipv6().main())
