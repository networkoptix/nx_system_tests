...
class test_ubuntu22_v0_ipv4_multiple(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_display_address(args.distrib_url, 'ubuntu22', 'v0', ['10.10.10.1/24', '10.10.11.1/24', '10.10.12.1/24'], exit_stack)


if __name__ == '__main__':
    exit(test_ubuntu22_v0_ipv4_multiple().main())
