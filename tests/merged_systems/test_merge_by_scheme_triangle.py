...
class test_v0(VMSTest):
    ...
    def _run(self, args, exit_stack):
        _test_merge_by_scheme_triangle(args.distrib_url, 'v0', exit_stack)


def _test_merge_by_scheme_triangle(distrib_url, api_version, exit_stack):
    ...
    setup_system(mediaservers, [
        ...
        {'local': 'second', 'remote': 'proxy-1', 'take_remote_settings': True, 'network': '10.254.2.0/24'},
        ])
