...
def _test_mediaserver_data_synchronization(distrib_url, layout_file, api_version, exit_stack):
    ...
    for idx in range(TEST_SIZE):
        ...
        server_primary = generate_mediaserver(index=idx + 1)
        user_attributes = generate_mediaserver_user_attributes(server_primary)
        api.add_generated_mediaserver(server_primary, user_attributes)
