...
from tests.web_admin._system_settings import SecuritySettings
...
def _test_control_availability(args, exit_stack: ExitStack):
    ...
    security_settings = SecuritySettings(browser)
    system_form = SystemNameForm(browser)
    assert_elements_absence(
        system_form.get_merge_with_another_button,
        security_settings.get_enable_audit_trail,
        security_settings.get_traffic_force_encryption,
        security_settings.get_video_force_encryption,
        security_settings.get_limit_session_duration,
        security_settings.get_limit_session_duration_interval,
        security_settings.get_time_unit_select,
        )
