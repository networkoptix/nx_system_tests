...
def _test(args, exit_stack: ExitStack):
    ...
    custom_group_id = first_api.add_user_group(custom_group_name, Permissions.NONADMIN_FULL_PRESET)
    custom_user_name = "custom_user"
    custom_user_password = "custom_user_password"
    first_api.add_local_user(custom_user_name, custom_user_password, group_id=custom_group_id)
    ...
    assert element_is_present(inactive_camera_preview.get_empty_archive)
