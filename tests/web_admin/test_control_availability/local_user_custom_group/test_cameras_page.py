...
def _test(args, exit_stack: ExitStack):
    ...
    mediaserver_api = first_stand.api()
    ...
    assert not element_is_present(first_camera_component.get_detailed_info_button)
    ...
    assert not element_is_present(second_camera_component.get_detailed_info_button)
