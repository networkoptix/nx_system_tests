...
class test_general_page(WebAdminTest):
    ...
    TestRail: https://networkoptix.testrail.net/index.php?/cases/view/122607
    """
...
def _test(args, exit_stack: ExitStack):
    ...
    mediaserver_api.add_multi_group_local_user(
        custom_user_name, custom_user_password, group_ids=[Groups.LIVE_VIEWERS, custom_group_id])
    ...
    assert GroupNames.LIVE_VIEWERS in permission_groups_text, (
        f"{GroupNames.LIVE_VIEWERS!r} not in {permission_groups_text!r}"
        )
