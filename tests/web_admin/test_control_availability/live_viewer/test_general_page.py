...
class test_pages_control_availability(WebAdminTest):
    ...
    TestRail: https://networkoptix.testrail.net/index.php?/cases/view/122529
    """
    ...
    def _run(self, args, exit_stack: ExitStack):
        ...
        live_viewer_password = "live_viewer_password"
        mediaserver_api.add_local_user(live_viewer, live_viewer_password, group_id=Groups.LIVE_VIEWERS)
        ...
        login_form.get_login_field().put(live_viewer)
        login_form.get_password_field().put(live_viewer_password)
        ...
        assert system_form.get_permissions().get_text() == GroupNames.LIVE_VIEWERS
