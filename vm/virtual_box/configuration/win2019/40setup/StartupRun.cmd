...
@rem Disable time sync not to interfere with time synchronization tests.
@rem Say not to sync, delete servers, disable service.
@rem It's possible to unregister it with `w32tm /unregister` but that deletes first setting.
