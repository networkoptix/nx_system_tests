...
from arms.beg_ft002.local_resources import get_rpi4_named_distributor
from arms.beg_ft002.local_resources import rpi4_installation_distributor
from arms.beg_ft002.local_resources import rpi4_prerequisites_distributor
...
async def main():
    async with aclosing(status_endpoint(_name)) as machine_status:
        await serve_contracts_loop(
            ...
            distributors=[
                get_rpi4_named_distributor(_name),
                rpi4_prerequisites_distributor,
                rpi4_installation_distributor,
                ],
